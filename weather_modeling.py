...
result_hardcoded = temperature_modeling(a_hardcoded, b_hardcoded, c_hardcoded,time_hardcoded)
print(f"Temperature for hardcoded coefficients at time {time_hardcoded} hours: {result_hardcoded}")
print("\n")
...
result_keyboard = temperature_modeling(a_keyboard, b_keyboard, c_keyboard,
                                       time_keyboard)
print(f"Temperature for keyboard input coefficients at time {time_keyboard} hours: {result_keyboard}")
print("\n")
...
print(f"Temperature for file input coefficients at time {time_file} hours: {result_file}")
print("\n")
